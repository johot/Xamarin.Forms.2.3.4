		...
		where T : View, new()
	{
		...
		protected virtual void Build(StackLayout stackLayout)
		{
			...
			var viewContainers = new[]
			{
				...
				_isVisibleStateViewContainer =
					new StateViewContainer<T>(Test.VisualElement.IsVisible, new T { IsVisible = true }),

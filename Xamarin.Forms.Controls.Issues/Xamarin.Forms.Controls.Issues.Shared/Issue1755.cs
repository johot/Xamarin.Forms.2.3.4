...
namespace Xamarin.Forms.Controls
{
    ...
    [Issue(IssueTracker.Github, 1755, "Initializing a map with a different MapType other than default has no effect",
        ...
        : ContentPage
    {
        public Issue1755()
        {
            ...
            switchMapTypeButton.Clicked +=
                (sender, args) => map.MapType = map.MapType == MapType.Hybrid ? MapType.Street : MapType.Hybrid;

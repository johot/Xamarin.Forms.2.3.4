...
namespace Xamarin.Forms
{
	public partial class FlexLayout : Layout<View>
	{
		...
		public static readonly BindableProperty JustifyContentProperty = BindableProperty.Create(nameof(JustifyContent), typeof(Justify), typeof(FlexLayout), default(Justify), propertyChanging: (s, o, n) => { GetNode((View)s).JustifyContent = (Justify)n; (s as FlexLayout).InvalidateLayout(); });

		public static readonly BindableProperty AlignContentProperty = BindableProperty.Create(nameof(AlignContent), typeof(Align), typeof(FlexLayout), default(Align), propertyChanging: (s, o, n) => { GetNode((View)s).AlignContent = (Align)n; (s as FlexLayout).InvalidateLayout(); (s as FlexLayout).InvalidateLayout(); });

		public static readonly BindableProperty AlignItemsProperty = BindableProperty.Create(nameof(AlignItems), typeof(Align), typeof(FlexLayout), default(Align), propertyChanging: (s, o, n) => { GetNode((View)s).AlignItems = (Align)n; (s as FlexLayout).InvalidateLayout(); });

		public static readonly BindableProperty PositionProperty = BindableProperty.Create(nameof(Position), typeof(Position), typeof(FlexLayout), default(Position), propertyChanging: (s, o, n) => { GetNode((View)s).PositionType = (Position)n; (s as FlexLayout).InvalidateLayout(); });

		public static readonly BindableProperty OverflowProperty = BindableProperty.Create(nameof(Overflow), typeof(Overflow), typeof(FlexLayout), default(Overflow), propertyChanging: (s, o, n) => { GetNode((View)s).Overflow = (Overflow)n; (s as FlexLayout).InvalidateLayout(); });

		public static readonly BindableProperty WrapProperty = BindableProperty.Create(nameof(Wrap), typeof(Wrap), typeof(FlexLayout), default(Wrap), propertyChanging: (s, o, n) => { GetNode((View)s).Wrap = (Wrap)n; (s as FlexLayout).InvalidateLayout(); });

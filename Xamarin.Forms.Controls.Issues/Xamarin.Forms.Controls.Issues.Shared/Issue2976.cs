...
namespace Xamarin.Forms.Controls.Issues
{
    ...
    [Issue(IssueTracker.Github, 2976, "Sample 'WorkingWithListviewNative' throw Exception on Xam.Android project.",
...
#pragma warning restore 618
                        Text =
                            Device.RuntimePlatform == Device.iOS
                                ? "Custom renderer UITableView"
                                : Device.RuntimePlatform == Device.Android
                                    ? "Custom renderer ListView"

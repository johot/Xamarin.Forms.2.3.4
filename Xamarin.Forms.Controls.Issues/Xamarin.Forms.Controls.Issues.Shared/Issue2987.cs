...
namespace Xamarin.Forms.Controls
{
    ...
    [Issue(IssueTracker.Github, 2987,
        "When setting the minimum and maximum date for a date picker, only allow valid dates to be seen/selected from the DatePicker dialog",
    ...
    public class Issue2987 : TestContentPage
    {
        ...
        protected override void Init()
        {
            ...
            datePicker.DateSelected += (object sender, DateChangedEventArgs e) => { Debug.WriteLine("Date changed"); };

...
namespace Xamarin.Forms.Controls
{
    ...
    internal class CoreContentPage : ContentPage
    {
        public CoreContentPage()
        {
            ...
            {
                Children = { new CoreRootView(), new CorePageView(this, NavigationBehavior.PushModalAsync) }
            };
        }
    }
    ...
    internal class CorePageView : ListView
    {
        ...
        List<GalleryPageFactory> _pages = new List<GalleryPageFactory>
        {
            ...
            new GalleryPageFactory(() => new ScrollGallery(ScrollOrientation.Horizontal),
                "ScrollView Gallery Horizontal"),
        ...
        public CorePageView(Page rootPage, NavigationBehavior navigationBehavior = NavigationBehavior.PushAsync)
        {
            ...
            {
                _pages.Add(new GalleryPageFactory(() => new NavigationBarGallery((NavigationPage)rootPage),
                    "NavigationBar Gallery - Legacy"));
            }

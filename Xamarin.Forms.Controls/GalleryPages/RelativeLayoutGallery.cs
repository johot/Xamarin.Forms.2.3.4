    ...
    public class RelativeLayoutGallery : ContentPage
    {
        public RelativeLayoutGallery()
        {
            ...
            for (var i = 0; i < 200; i++)
            {
                ...
                Func<View, bool> pastBounds =
                    view => relativeTo.Bounds.Right + padding + relativeTo.Width > layout.Width;
                layout.Children.Add(box,
                    () => new Rectangle(pastBounds(relativeTo) ? box1.X : relativeTo.Bounds.Right + padding,

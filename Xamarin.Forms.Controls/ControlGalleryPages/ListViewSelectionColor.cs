...
namespace Xamarin.Forms.Controls
{
    internal sealed class ListViewSelectionColor : ContentPage
    {
        ...
        public ListViewSelectionColor()
        {
            ...
            {
                new Grouping<string, Artist>("Prog",
                    new List<Artist> { new Artist("King Crimson"), new Artist("Yes"), new Artist("Rush") }),
                new Grouping<string, Artist>("Techno",
                    new List<Artist>
                    {
                        new Artist("Juan Atkins"),
                        new Artist("Jeff Mills"),
                        new Artist("Gerald Donald")
                    }),
                new Grouping<string, Artist>("Pop",
                    new List<Artist> { new Artist("Japan"), new Artist("Roxy Music"), new Artist("Talking Heads") }),
            };
            ...
            {
                Text = "Clear",
                Command = new Command(() => { currentList.SelectedItem = null; })
            };

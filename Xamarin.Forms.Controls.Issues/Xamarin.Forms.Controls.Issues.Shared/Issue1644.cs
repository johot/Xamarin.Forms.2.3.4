...
namespace Xamarin.Forms.Controls
{
    ...
    [Issue(IssueTracker.Github, 1644, "ListView reappearing and selecting its item causes jobject exception",
    ...
    public class Issue1644Menu : MasterDetailPage
    {
        ...
        public Issue1644Menu()
        {
            ...
            button.Clicked += (sender, e) => { Navigation.PushAsync(_secondPage); };

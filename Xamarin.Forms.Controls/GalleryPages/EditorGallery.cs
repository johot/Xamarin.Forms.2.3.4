...
namespace Xamarin.Forms.Controls
{
	...
	internal class EditableEditorPage : ContentPage
	{
		public EditableEditorPage(string title, bool enabled)
		{
			...
			disableButton.Clicked += (object sender, EventArgs e) => { editor.IsEnabled = false; };

			enableButton.Clicked += (object sender, EventArgs e) => { editor.IsEnabled = true; };
	...
	public class EditorGalleryPage : ContentPage
	{
		public EditorGalleryPage(string title, Keyboard keyboard)
		{
			...
			editor.Completed += (sender, e) => { label.Text = "Entered : " + editor.Text; };

			editor.TextChanged += (sender, e) => { label2.Text += "x"; };
			...
			unfocus.Clicked += (sender, e) => { editor.Unfocus(); };

			focus.Clicked += (sender, e) => { editor.Focus(); };

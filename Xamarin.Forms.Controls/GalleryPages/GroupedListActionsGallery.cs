		...
		ObservableList<Group> CreateItemSource()
		{
			return new ObservableList<Group>
			{
				...
				new Group("Child item actions")
				{
					...
					new GroupAction("Insert 2 group items",
						ga => ga.Parent.InsertRange(1, GetGroupActions("Inserted item D", 2))),
					...
					new GroupAction("Replace dummy item",
						ga => ga.Parent[GetIndexOfDummy(ga)] = new GroupAction("Replaced item")),

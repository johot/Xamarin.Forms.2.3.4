...
namespace Xamarin.Forms.Controls
{
    public class AutomationIdGallery : ContentPage
    {
        public AutomationIdGallery()
        {
            ...
            {
                AutomationId = "tbItemHello",
                Text = "Hello",
                Command = new Command(async () => { await DisplayAlert("Hello", "", "ok"); })
            };
            var toolBarItem2 = new ToolbarItem
            {
                AutomationId = "tbItemHello2",
                Order = ToolbarItemOrder.Secondary,
                Text = "Hello2",
                Command = new Command(async () => { await DisplayAlert("Hello2", "", "ok"); })
            };
        ...
        internal class TestPage1 : ContentPage
        {
            public TestPage1()
            {
                ...
                rootLayout.Children.Add(new DatePicker
                {
                    AutomationId = "dtPicker",

...
namespace Xamarin.Forms.Controls
{
    ...
    [Issue(IssueTracker.Bugzilla, 42075, "IllegalStateException - Fragment does not have a view",
    ...
    public class Bugzilla42075 : TestTabbedPage
    {
        protected override void Init()
        {
            ...
            const string text =
                @"To run this test, you'll need to have an emulator or device in Developer mode, with the ""Don't Keep Activities"" setting turned on.

...
namespace Xamarin.Forms.Controls
{
    ...
    [Issue(IssueTracker.Github, 2266,
        "Setting a different Detail page from a MasterDetailPage after 2nd time on MainPage", PlatformAffected.iOS,
    ...
    public class Issue2266 : ContentPage
    {
        ...
        void InitPageContent()
        {
            ...
            listView.ItemSelected += delegate(object sender, SelectedItemChangedEventArgs e)
            {
                ...
                else if (e.SelectedItem.Equals(listItems[1]) || e.SelectedItem.Equals(listItems[2]) ||
    ...
    public class MasterDetailNavigation : MasterDetailPage
    {
        ...
        void InitPages()
        {
            ...
            for (int i = 1; i <= 10; i++)
            {
                ...
                btnSubPage.Clicked += delegate { OpenSubPage(string.Format("Sub for page: {0}", i)); };
                ...
                page.ToolbarItems.Add(new ToolbarItem("START", null,

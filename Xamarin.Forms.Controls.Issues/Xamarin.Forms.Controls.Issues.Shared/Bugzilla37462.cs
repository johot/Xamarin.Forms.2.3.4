...
namespace Xamarin.Forms.Controls.Issues
{
	...
	[Issue(IssueTracker.Bugzilla, 37462, "Using App Compat/App Compat theme breaks Navigation.RemovePage on Android ",
	...
	public class Bugzilla37462 : TestNavigationPage
	{
		protected override void Init()
		{
			...
			page1.Appearing +=
				(sender, args) => { ((IVisualElementController)page1).InvalidateMeasure(InvalidationTrigger.MeasureChanged); };

...
namespace Xamarin.Forms.Controls.Issues
{
	...
	public class Bugzilla36788 : TestContentPage // or TestMasterDetailPage, etc ...
	{
		...
		protected override void Init()
		{
			...
			var longString =
				"Very long text in single line to be truncated at tail. Adding extra text to make sure it gets truncated. And even more extra text because otherwise the test might fail if we're in, say, landscape orientation rather than portrait.";

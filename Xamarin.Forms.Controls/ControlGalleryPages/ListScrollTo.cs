...
namespace Xamarin.Forms.Controls
{
        ...
        : ContentPage
    {
        ...
        public ListScrollTo()
        {
            ...
            visible.Clicked +=
                (sender, args) => _listView.ScrollTo(_items[4][4], _items[4], ScrollToPosition.MakeVisible, _animate);

            var start = new Button { Text = "Start" };
            start.Clicked +=
                (sender, args) => _listView.ScrollTo(_items[4][4], _items[4], ScrollToPosition.Start, _animate);

            var center = new Button { Text = "Center" };
            center.Clicked +=
                (sender, args) => _listView.ScrollTo(_items[4][4], _items[4], ScrollToPosition.Center, _animate);

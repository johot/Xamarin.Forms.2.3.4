...
namespace Xamarin.Forms.Controls
{
    ...
    [Issue(IssueTracker.Github, 1758, "LayoutTo needs to be smarted about using layout specific API calls",
    ...
    public class Issue1758 : ContentPage
    {
        ...
        Layout Absolute()
        {
            ...
            AbsoluteLayout.SetLayoutBounds(_button,
                new Rectangle(0, 300, AbsoluteLayout.AutoSize, AbsoluteLayout.AutoSize));

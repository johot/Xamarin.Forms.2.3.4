...
public class Activity1 : FormsAppCompatActivity
{
    ...
    void AddNativeBindings(NativeBindingGalleryPage page)
    {
        ...
        var buttonColor = new Android.Widget.Button(this) { Text = "Change label Color" };
    ...
    void AddNativeControls(NestedNativeControlGalleryPage page)
    {
        ...
        // Create and add a native Button 
        var button = new Android.Widget.Button(this) { Text = "Click to change TextView font size" };
        float originalSize = textView.TextSize;
        button.Click += (sender, args) => { textView.TextSize = textView.TextSize == originalSize ? 24 : 14; };
    ...
    static SizeRequest? SizeBrokenControl(NativeViewWrapperRenderer renderer,
        int widthConstraint, int heightConstraint)
    {
        Android.Views.View nativeView = renderer.Control;
        ...
        int widthSpec = Android.Views.View.MeasureSpec.MakeMeasureSpec(width * 2,
            Android.Views.View.MeasureSpec.GetMode(widthConstraint));
        nativeView.Measure(widthSpec, heightConstraint);
        var size = new Size(nativeView.MeasuredWidth, nativeView.MeasuredHeight);
        return new SizeRequest(size);
    }
    ...
    public class ColorConverter : IValueConverter
    {
        ...
        {
            if (value is Android.Graphics.Color)
                return ((Android.Graphics.Color)value).ToColor();

...
namespace Xamarin.Forms.Controls.Issues
{
    ...
    public class Bugzilla42277 : TestContentPage
    {
        ...
        class MyDataTemplateSelector : DataTemplateSelector
        {
            ...
            {
                _1Template = new DataTemplate(() => { return new TextCell { Text = Success1 }; });

                _2Template = new DataTemplate(() => { return new TextCell { Text = Success2 }; });

                _3Template = new DataTemplate(() => { return new TextCell { Text = Success3 }; });

                _4Template = new DataTemplate(() => { return new TextCell { Text = Success4 }; });

                _5Template = new DataTemplate(() => { return new TextCell { Text = Success5 }; });

                _6Template = new DataTemplate(() => { return new TextCell { Text = Success6 }; });
            }
        ...
        protected override void Init()
        {
            ...
            groupedListView.ItemsSource = new List<List<int>>
            {
                Enumerable.Range(2, 2).ToList(),
                Enumerable.Range(4, 2).ToList()
            };
        }

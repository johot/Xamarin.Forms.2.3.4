		...
		public class ModalActivityIndicator : RelativeLayout
		{
			public ModalActivityIndicator()
			{
				...
				Children.Add(
					...
					widthConstraint: global::Xamarin.Forms.Constraint.RelativeToParent((parent) => {
						return parent.Width;
					}),
					heightConstraint: global::Xamarin.Forms.Constraint.RelativeToParent((parent) => {
				...
				Children.Add(
					...
					xConstraint: global::Xamarin.Forms.Constraint.RelativeToParent((parent) => {
						return parent.Width / 4;
					}),
					yConstraint: global::Xamarin.Forms.Constraint.RelativeToParent((parent) => {

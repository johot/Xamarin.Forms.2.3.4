        ...
        protected override void Init()
        {
            ...
            Detail =
                new NavigationPage(new ContentPage
                {
                    Content =
                        ...
                        {
                            Text =
                                "The status bar text color on this page should be white on blue. When you show the Master page fully, the status bar text should be black on white. If the status bar text remains white when the Master page is fully presented, this test has failed."
                        }
                });
            ...
            IsPresentedChanged += (sender, e) =>
            {
                ...
                if (mp.IsPresented)
                    ...
                    ((NavigationPage)mp.Detail).On<iOS>()

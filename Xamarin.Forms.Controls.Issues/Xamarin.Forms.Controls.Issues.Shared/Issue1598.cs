...
namespace Xamarin.Forms.Controls
{
    ...
    [Issue(IssueTracker.Github, 1598,
        "MasterDetailContainer does not handle adding of views which are already its children", PlatformAffected.Android
    )]
    public class Issue1598 : ContentPage
    {
        ...
        public Issue1598()
        {
            ...
            menu1.Tapped += (o, e) => { Navigation.PushAsync(_secondPage); };

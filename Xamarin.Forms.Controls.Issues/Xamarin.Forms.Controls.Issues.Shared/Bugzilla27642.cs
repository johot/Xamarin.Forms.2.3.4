...
namespace Xamarin.Forms.Controls
{
    ...
    [Issue(IssueTracker.Bugzilla, 27642,
        "[Windows Phone] Adding a ScrollView control to a ContentView, remove it and re-add it will cause an exception on Windows Phone"
    )]

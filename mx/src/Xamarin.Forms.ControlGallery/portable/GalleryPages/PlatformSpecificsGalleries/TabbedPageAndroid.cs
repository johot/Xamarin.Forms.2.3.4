...
namespace Xamarin.Forms.Controls.GalleryPages.PlatformSpecificsGalleries
{
	public class TabbedPageAndroid : TabbedPage
	{
		public TabbedPageAndroid(ICommand restore)
		{
			...
			Children.Add(CreateAdditonalPage());
			Children.Add(CreateAdditonalPage());
			On<global::Xamarin.Forms.PlatformConfiguration.Android>().SetOffscreenPageLimit(2);
		}
			...
			var content = new StackLayout
			{
				...
				Children =
				{
					new Button
					{
						...
						Command = new Command(() => On<global::Xamarin.Forms.PlatformConfiguration.Android>()
							.SetIsSwipePagingEnabled(!On<global::Xamarin.Forms.PlatformConfiguration.Android>().IsSwipePagingEnabled()))
					},
					offscreenPageLimit
				}
			};

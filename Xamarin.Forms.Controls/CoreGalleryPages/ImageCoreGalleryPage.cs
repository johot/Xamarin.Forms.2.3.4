...
namespace Xamarin.Forms.Controls
{
    internal class ImageCoreGalleryPage : CoreGalleryPage<Image>
    {
        ...
        protected override void Build(StackLayout stackLayout)
        {
            ...
            var aspectFillContainer = new ViewContainer<Image>(Test.Image.AspectFill,
                new Image { Aspect = Aspect.AspectFill });
            var aspectFitContainer = new ViewContainer<Image>(Test.Image.AspectFit,
            ...
            var sourceContainer = new ViewContainer<Image>(Test.Image.Source,
                new Image { Source = "http://sethrosetter.com/images/projects/bezierdraw/bezierdraw_5.jpg" });

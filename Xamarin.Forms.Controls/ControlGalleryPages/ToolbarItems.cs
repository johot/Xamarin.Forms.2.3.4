namespace Xamarin.Forms.Controls
{
	public class ToolbarItems : ContentPage
	{
		...
		public ToolbarItems()
		{
			...
			var tb1 = new ToolbarItem("tb1", "menuIcon.png", () => { label.Text = "tb1"; }, ToolbarItemOrder.Primary);
			tb1.IsEnabled = _isEnable;
			tb1.AutomationId = "toolbaritem_primary";
			tb1.IsEnabled = _isEnable;

			var tb2 = new ToolbarItem("tb2", null, () => { label.Text = "tb2"; }, ToolbarItemOrder.Primary);
			tb2.AutomationId = "toolbaritem_primary2";

			var tb3 = new ToolbarItem("tb3", "bank.png", () => { label.Text = "tb3"; }, ToolbarItemOrder.Secondary);

namespace Xamarin.Forms.Controls
{
    public class ActionSheetGallery : ContentPage
    {
            ...
            Content = new ScrollView
            {
                Content = new StackLayout
                {
                    ...
                    Children =
                    {
                        ...
                        MakeActionSheetButton(this, "ActionSheet Cancel Destruction Extras", null, "Cancel",
                            "Destruction", extras),
                        ...
                        MakeActionSheetButton(this, "ActionSheet Title Cancel Destruction", "Title", "Cancel",
                            "Destruction"),
                        MakeActionSheetButton(this, "ActionSheet Title Cancel Destruction Extras", "Title", "Cancel",
                            "Destruction", extras),
                        MakeActionSheetButton(this, "ActionSheet Title Destruction", "Title", null, "Destruction"),
                        MakeActionSheetButton(this, "ActionSheet Title Destruction Extras", "Title", null, "Destruction",
                            extras),
        ...
        static Button MakeActionSheetButton(Page page, string buttonText, string title, string cancel,
            string destruction, params string[] extras)
        {
            ...
            actionSheetButton.Clicked +=
                async (sender, e) => await page.DisplayActionSheet(title, cancel, destruction, extras);

...
namespace Xamarin.Forms.Controls.Issues
{
    ...
    [Issue(IssueTracker.Bugzilla, 32902,
        "[iOS | iPad] App Crashes (without debug log) when Master Detail isPresented and navigation being popped")]
    public class Bugzilla32902 : TestContentPage // or TestMasterDetailPage, etc ...
    {
        ...
        protected override void Init()
        {
            ...
            rootContentPageButton.Clicked += async (sender, args) => { await Navigation.PushAsync(FirstContentPage); };
            ...
            firstContentPageButton.Clicked += async (sender, args) => { await Navigation.PushModalAsync(HomePage); };

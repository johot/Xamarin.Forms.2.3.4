                        ...
                        .Select(
                            i =>
                            {
                                return new MessageViewModel
                                {
                                    ...
                                    MessagePreview = "Lorem ipsum dolorem monkeys bonkers " + i
                                };
                            }));

            MessagingCenter.Subscribe<MessageViewModel, MessageViewModel>(this, "DeleteMessage",
                (vm, vm2) => { Messages.Remove(vm); });
        }

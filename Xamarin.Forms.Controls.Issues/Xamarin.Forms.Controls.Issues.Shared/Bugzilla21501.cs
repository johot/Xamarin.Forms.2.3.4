...
namespace Xamarin.Forms.Controls
{
	...
	[Issue(IssueTracker.Bugzilla, 21501, "ListView: Button in ItemTemplate breaks SelectedItem",
	...
	public class Bugzilla21501 : ContentPage
	{
		public Bugzilla21501()
		{
			...
			listView.ItemSelected += (sender, args) => { resultLabel.Text = resultLabel.Text + "!"; };

	...
	public class Issue1758 : ContentPage
	{
		...
		Layout Relative()
		{
			...
			layout.Children.Add(_list,
				global::Xamarin.Forms.Constraint.RelativeToParent(p => p.X),
				global::Xamarin.Forms.Constraint.RelativeToParent(p => p.Y),
				global::Xamarin.Forms.Constraint.RelativeToParent(p => p.Width),
				global::Xamarin.Forms.Constraint.RelativeToParent(p => p.Height)
			);
        
			layout.Children.Add(_button, 
				global::Xamarin.Forms.Constraint.Constant(0),
				global::Xamarin.Forms.Constraint.Constant(300));

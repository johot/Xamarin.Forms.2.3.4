    ...
    public class Bugzilla28709 : TestContentPage // or TestMasterDetailPage, etc ...
    {
        protected override void Init()
        {
            ...
            btn1.Clicked += (sender, e) =>
            {
                Task.Run(() =>
                {
                    System.Diagnostics.Debug.WriteLine("thread 1");
                    OnButtonClicked1("thread1", new EventArgs());
                });
                Task.Run(() =>
                {
                    System.Diagnostics.Debug.WriteLine("thread 2");
                    OnButtonClicked1("thread2", new EventArgs());
                });
                Task.Run(() =>
                {
                    System.Diagnostics.Debug.WriteLine("thread 3");
                    OnButtonClicked1("thread3", new EventArgs());
                });
            };

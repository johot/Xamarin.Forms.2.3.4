...
namespace Xamarin.Forms.Controls.TestCasesPages
{
    ...
    public class Bugzilla34072 : TestContentPage
    {
        ...
        protected override void Init()
        {
            ...
            {
                Text =
                    "Tap the 'Switch Enabled State' button. The top button text should be grayed out when the button is Disabled. If the text remains the same color in both states, this is broken."
            };

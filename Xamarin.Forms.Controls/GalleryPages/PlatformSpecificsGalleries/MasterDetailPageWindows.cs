...
namespace Xamarin.Forms.Controls.GalleryPages.PlatformSpecificsGalleries
{
	...
	public class NavigationPageWindows : NavigationPage
	{
		...
		ContentPage CreateRoot(ICommand restore)
		{
			...
			var content = new StackLayout { VerticalOptions = LayoutOptions.Fill, HorizontalOptions = LayoutOptions.Fill };
			...
			content.Children.Add(CreateToolbarPlacementChanger(this));
			content.Children.Add(CreateAddRemoveToolBarItemButtons(this));
